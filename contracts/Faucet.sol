...
contract Faucet is Ownable{
    ...
    function gimme() external {
        nonce++;
        ERC20a.mint(msg.sender, 1000000000000000000);
        ERC20b.mint(msg.sender, 1000000000000000000);
        ERC20c.mint(msg.sender, 1000000000000000000);
        ERC721a.mint(msg.sender, nonce);
        ERC721b.mint(msg.sender, nonce);
        ERC1155a.mint(msg.sender, nonce, 1, ""); // ERC1155 NFT
        ERC1155a.mint(msg.sender, 0, 1, ""); // ERC1155 fungible token
        ERC1155b.mint(msg.sender, nonce, 1, ""); // ERC1155 NFT
    }
