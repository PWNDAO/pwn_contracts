...
contract PWN is Ownable {
     ...
     *  @returns a Deed ID of the newly created Deed
     */
    function newDeed(
        uint8   _cat,
        uint256 _id,
     ...
     *  @returns a hash of the newly created offer
     */
    function makeOffer(
        uint8 _cat,
        uint256 _amount,
     ...
     *  @param _did - Deed ID specifying the deed being processed
