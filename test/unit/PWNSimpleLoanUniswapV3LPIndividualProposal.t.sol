...
} from "pwn/loan/terms/simple/proposal/PWNSimpleLoanUniswapV3LPIndividualProposal.sol";

import { PWNSimpleLoanUniswapV3LPIndividualProposalHarness } from "test/harness/PWNSimpleLoanUniswapV3LPIndividualProposalHarness.sol";
import {
    MultiToken,
    Math,
...
abstract contract PWNSimpleLoanUniswapV3LPIndividualProposalTest is PWNSimpleLoanProposalTest {

    PWNSimpleLoanUniswapV3LPIndividualProposalHarness proposalContract;
    ...
    event ProposalMade(bytes32 indexed proposalHash, address indexed proposer, PWNSimpleLoanUniswapV3LPIndividualProposal.Proposal proposal);
    ...
    function setUp() virtual public override {
        ...
        proposalContract = new PWNSimpleLoanUniswapV3LPIndividualProposalHarness(hub, revokedNonce, config, utilizedCredit, uniswapV3Factory, uniswapNFTPositionManager, feedRegistry, address(0), weth);
    ...
    function _proposalHash(PWNSimpleLoanUniswapV3LPIndividualProposal.Proposal memory _proposal) internal view returns (bytes32) {
        return keccak256(abi.encodePacked(
            "\x19\x01",
            keccak256(abi.encode(
                keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
                keccak256("PWNSimpleLoanUniswapV3LPIndividualProposal"),
                keccak256("1.0"),
                block.chainid,
...
contract PWNSimpleLoanUniswapV3LPIndividualProposal_RevokeNonce_Test is PWNSimpleLoanUniswapV3LPIndividualProposalTest {
...
contract PWNSimpleLoanUniswapV3LPIndividualProposal_GetProposalHash_Test is PWNSimpleLoanUniswapV3LPIndividualProposalTest {
...
contract PWNSimpleLoanUniswapV3LPIndividualProposal_MakeProposal_Test is PWNSimpleLoanUniswapV3LPIndividualProposalTest {
...
contract PWNSimpleLoanUniswapV3LPIndividualProposal_EncodeProposalData_Test is PWNSimpleLoanUniswapV3LPIndividualProposalTest {
...
contract PWNSimpleLoanUniswapV3LPIndividualProposal_DecodeProposalData_Test is PWNSimpleLoanUniswapV3LPIndividualProposalTest {

    function test_shouldReturnDecodedProposalData() external {
        (
            PWNSimpleLoanUniswapV3LPIndividualProposal.Proposal memory _proposal,
            PWNSimpleLoanUniswapV3LPIndividualProposal.ProposalValues memory _proposalValues
        ...
        assertEq(_proposal.token0Denominator, proposal.token0Denominator);
...
contract PWNSimpleLoanUniswapV3LPIndividualProposal_GetCreditAmount_Test is PWNSimpleLoanUniswapV3LPIndividualProposalTest {
...
contract PWNSimpleLoanUniswapV3LPIndividualProposal_AcceptProposal_Test is PWNSimpleLoanUniswapV3LPIndividualProposalTest, PWNSimpleLoanProposal_AcceptProposal_Test(3) {

    function setUp() virtual public override(PWNSimpleLoanUniswapV3LPIndividualProposalTest, PWNSimpleLoanProposalTest) {
        super.setUp();
    ...
    function test_shouldFail_whenZeroMinCreditAmount() external {
        ...
        vm.expectRevert(abi.encodeWithSelector(PWNSimpleLoanUniswapV3LPIndividualProposal.MinCreditAmountNotSet.selector));
    ...
    function test_shouldFail_whenCreditAmountLessThanMinCreditAmount() external {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PWNSimpleLoanUniswapV3LPIndividualProposal.InsufficientCreditAmount.selector,
                token0Value,
...
contract PWNSimpleLoanUniswapV3LPIndividualProposal_Erc712EncodeProposal_Test is PWNSimpleLoanUniswapV3LPIndividualProposalTest {

    function test_shouldERC712EncodeProposal() external {
        PWNSimpleLoanUniswapV3LPIndividualProposal.ERC712Proposal memory proposalErc712 = PWNSimpleLoanUniswapV3LPIndividualProposal.ERC712Proposal(
