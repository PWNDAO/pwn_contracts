...
/**
 * @title PWN Simple Loan Uniswap V3 LP Individual Proposal
 * @notice Simple loan proposal contract for an individual Uniswap V3 LP.
 * Proposal uses Chainlink price feeds to get LP token value in credit token.
 */
contract PWNSimpleLoanUniswapV3LPIndividualProposal is PWNSimpleLoanProposal {
    ...
    constructor(
        ...
        address _weth
    ) PWNSimpleLoanProposal(_hub, _revokedNonce, _config, _utilizedCredit, "PWNSimpleLoanUniswapV3LPIndividualProposal", VERSION) {
